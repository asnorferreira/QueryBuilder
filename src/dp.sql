...
(1,'Neve E. Finch','lacinia.at@nonummyutmolestie.org','(83) 0124-7289'),
(2,'Jaime Cochran','ipsum.porta@turpisvitaepurus.co.uk','(88) 3163-6961'),
(3,'Mia Castillo','fringilla.cursus@aliquetsemut.net','(37) 9218-3566'),
(4,'Francesca Faulkner','enim.sit.amet@Aeneaneuismodmauris.edu','(71) 0532-8316'),
(5,'Ignatius Coffey','orci.Phasellus@Quisque.org','(78) 2943-0071'),
(6,'Stuart O. Fisher','suscipit.nonummy.Fusce@molestiedapibusligula.org','(32) 5997-0271'),
(7,'Gretchen F. Woodard','diam.Proin.dolor@a.org','(71) 8255-4173'),
(8,'Axel Parks','Suspendisse.commodo@Fusce.co.uk','(70) 2104-5173'),
(9,'Vladimir R. Knowles','consectetuer@Nuncullamcorpervelit.com','(31) 2577-1110');

INSERT INTO "agenda" (id, nome, email, telefone) VALUES 
(10,'Iola D. Osborne','scelerisque.sed@semperrutrum.net','(47) 5129-9536'),
(11,'Ina P. Frost','risus.varius@venenatisvelfaucibus.net','(07) 5162-0035'),
(12,'Lani J. Cortez','hendrerit.Donec.porttitor@lacus.ca','(48) 2220-3535'),
(13,'Maryam G. Estrada','molestie.tellus@NuncmaurisMorbi.net','(73) 7896-2491'),
(14,'Elmo Myers','magna@gravidasitamet.edu','(29) 4874-8870');

INSERT INTO "agenda" (id, nome, email, telefone) VALUES 
(15,'Dana N. Miles','purus.Nullam.scelerisque@milacinia.ca','(89) 7607-2040'),
(16,'Yael C. Cain','lacinia.vitae@egestasa.ca','(79) 3076-6921'),
(17,'Candice U. Poole','magna@semconsequatnec.org','(32) 5681-9099'),
(18,'Stacy N. Gonzalez','erat.Vivamus.nisi@Aeneaneuismod.ca','(26) 7116-1893'),
(19,'Leslie Lott','egestas.blandit.Nam@nascetur.com','(60) 0009-0024');
...
INSERT INTO "farmacia" (id,categoria,medicamento,estoque) VALUES (41,null,'Carvedilol',56),(42,'green','Simvastatin',31),(43,'green','Fluoxetine HCl',32),(44,null,'TriNessa',24),(45,'blue','Pantoprazole Sodium',75),(46,'red','Omeprazole (Rx)',35),(47,'yellow','Lisinopril',62),(48,'green','Omeprazole (Rx)',11),(49,'red','Zyprexa',65),(50,'blue','Lorazepam',77);
...
INSERT INTO "farmacia" (id,categoria,medicamento,estoque) VALUES (61,'green','Diovan',26),(62,'green','Azithromycin',48),(63,'green','Metformin HCl',24),(64,null,'Alprazolam',70),(65,'black','Tramadol HCl',5),(66,'green','Carvedilol',1),(67,'blue','Simvastatin',58),(68,'red','Doxycycline Hyclate',41),(69,'red','Tamsulosin HCl',74),(70,'yellow','Glipizide',24);
INSERT INTO "farmacia" (id,categoria,medicamento,estoque) VALUES (71,'red','Hydrocodone/APAP',20),(72,'green','Furosemide',54),(73,'green','Metformin HCl',67),(74,null,'Januvia',65),(75,'blue','Levothyroxine Sodium',28),(76,'black','Sertraline HCl',14),(77,'black','Alprazolam',61),(78,'red','Famotidine',37),(79,'yellow','Lisinopril/Hydrochlorothiazide',77),(80,'green','Ranitidine HCl',10);
INSERT INTO "farmacia" (id,categoria,medicamento,estoque) VALUES (81,'red','TriNessa',61),(82,'red','Premarin',59),(83,'yellow','Folic Acid',75),(84,null,'Amlodipine Besylate',65),(85,'blue','Citalopram HBr',14),(86,'red','Omeprazole (Rx)',7),(87,'red','Metoprolol Succinatee',61),(88,'blue','Prednisone',67),(89,'yellow','Triamcinolone Acetonide',0),(90,'black','Furosemide',1);
INSERT INTO "farmacia" (id,categoria,medicamento,estoque) VALUES (91,'black','Spiriva Handihaler',34),(92,'yellow','LevothyroxineSodium',6),(93,null,'Lisinopril',17),(94,'green','Levoxyl',50),(95,'red','Ciprofloxacin HCl',39),(96,'green','Lexapro',3),(97,'yellow','Potassium Chloride',59),(98,'red','Gianvi',8),(99,'blue','Hydrochlorothiazide',4),(100,'black','Methylprednisolone',41);
